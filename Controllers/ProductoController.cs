...
namespace trabajo_final_grupo_verde.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Precio,ImagenURL,Descripcion")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Precio,ImagenURL,Descripcion")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
