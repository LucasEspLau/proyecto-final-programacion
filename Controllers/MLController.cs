...
namespace trabajo_final_grupo_verde.Controllers
{
    public class MLController : Controller
    {
        ...
        public MLController(ILogger<MLController> logger, PredictionEnginePool<MLModel1.ModelInput, MLModel1.ModelOutput> predictionEnginePool)
        {
            _logger = logger;
