...
namespace trabajo_final_grupo_verde.Models
{
    public class EmailSender : IMyEmailSender
    {
        ...
        {
            var emailMessage = new MimeMessage();
            emailMessage.From.Add(new MailboxAddress("Empresa Vilife", "vilife.ecommerse@gmail.com"));
            emailMessage.To.Add(new MailboxAddress("", recipient));
            emailMessage.Subject = subject;

            // Obtener la ruta completa de la imagen
            var imagePath = "wwwroot/images/Vilife-Logo.png";
            ...
            using var client = new SmtpClient();
            await client.ConnectAsync("smtp.gmail.com", 587, MailKit.Security.SecureSocketOptions.StartTls);
            await client.AuthenticateAsync("vilife.ecommerse@gmail.com", "tkex kelb wwsd eacd");
            await client.SendAsync(emailMessage);
